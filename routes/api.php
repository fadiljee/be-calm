...
Route::prefix('v1')->group(function () {
    ...
    Route::middleware('auth:sanctum')->group(function () {
        ...
        Route::get('/messages/{receiverId}/info', [ChatController::class, 'participantInfo']);
    ...
    Route::get('/guru-bk', [UserController::class, 'index']);
        ...
        Route::middleware('role:admin')->prefix('admin')->group(function () {
            ...
            Route::get('/screening-history/{id}/answers', [AdminScreeningController::class, 'historyDetail']);
            Route::delete('/screening-history/{id}', [AdminScreeningController::class, 'destroy']);
